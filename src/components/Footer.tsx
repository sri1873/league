            ...
            <div className="footer">
                <div>
                    ...
                    <div className="follow">
                        ...
                        <ul>
                            <li><a href="https://www.linkedin.com/school/woxsen-university/" target="_blank" rel="noreferrer" >
                                <img src="https://woxsen.edu.in/assets/images/linkedin.webp" className="img-fluid" alt="icon" />
                                <span>Linkedin</span>
                            </a>
                            </li>
                            <li><a href="https://twitter.com/Woxsen" target="_blank" rel="noreferrer">
                                <img src="https://woxsen.edu.in/assets/images/twitter.webp" className="img-fluid" alt="icon" />
                                <span>Twitter</span></a>
                            </li>
                            <li><a href="https://www.instagram.com/woxsen_university/" target="_blank" rel="noreferrer">
                                <img src="https://woxsen.edu.in/assets/images/insta.webp" className="img-fluid" alt="icon" />
                                <span>Instagram</span>
                            </a>
                            </li>
                            <li><a href="https://www.youtube.com/channel/UCjh6E3poHz7IFRGpnYlQ4pQ" target="_blank" rel="noreferrer">
                                <img src="https://woxsen.edu.in/assets/images/youtube.webp" className="img-fluid" alt="icon" />
                                <span>You Tube</span></a>
                            </li>
                            <li><a href="https://woxsen.edu.in/blog/" target="_blank" rel="noreferrer">
