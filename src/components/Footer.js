...
const Footer =()=>{
    ...
    <div className="footer-container">
        ...
        <div className="logo" ><img alt="Woxsen Logo" src={logo}className="logo" /></div>
        <div>
        ©Copyright 2023 - Woxsen University <br/>
        <p>Designed and Developed by </p>
        <p>School of Technology</p>
        <a target={"_blank"} rel="noopener noreferrer" href="https://www.linkedin.com/in/arunchandra-boini/">B.Arun Chandra </a>
        <a target={"_blank"} rel="noopener noreferrer" href="https://www.linkedin.com/in/ks-srikumar/">K S Sri Kumar </a>
